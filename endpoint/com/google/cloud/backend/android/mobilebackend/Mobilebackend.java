...
public class Mobilebackend extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class EndpointV1 {
     ...
     */
	  ...
	  //This is what I want
    public Delete delete(java.lang.String kind, java.lang.String id, java.lang.String Owner) throws java.io.IOException {
      Delete result = new Delete(kind, id, Owner);
      initialize(result);
      return result;
    }
    ...
    public class Delete extends MobilebackendRequest<com.google.cloud.backend.android.mobilebackend.model.EntityDto> {
       ...
       * @since 1.13
       */
      protected Delete(java.lang.String kind, java.lang.String id, java.lang.String Owner) {
      ...
      public Delete setOwner(java.lang.String Owner) {
        this.Owner = Owner;
        return this;
      }
